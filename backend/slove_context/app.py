...
Node 3.4: Scene Draft generation jobs (Fake Provider only; no fact extraction).

No auth, queues, or live model clients. Spec / Scene Card approval is not
Canon approval. Scene Plan and Scene Draft are not Canon. There is no
Context Pack builder — draft jobs reference a static fixture. Built-in
/openapi.json is kept.
"""
