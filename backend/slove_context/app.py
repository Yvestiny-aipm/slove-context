...
No Canon APIs, auth, queues, or model clients. Spec approval is not
Canon approval. Built-in /openapi.json is kept.
"""
...
def create_app(
    *,
    ...
    """Build the app. Tests inject an in-memory repository and audit sink."""
